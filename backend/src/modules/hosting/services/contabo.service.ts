...
export class ContaboService {
  ...
  getVpsPricing(): Array<{
    ...
    // 2026 lineup (Cloud VPS 4-18, SSD variants) — EUR list prices from GET /v1/products.
    return [
      {
        productId: 'V153',
        name: 'VPS 4',
  ...
  getVdsPricing(): Array<{
    ...
    // Cloud VDS S-XXL (V8-V16) — EUR list prices from GET /v1/products, 2026 specs (AMD EPYC 7282).
    return [
      {
        productId: 'V8',
        name: 'VDS S',
