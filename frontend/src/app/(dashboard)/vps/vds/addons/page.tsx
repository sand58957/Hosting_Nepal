...
const availableAddons: Addon[] = [
  { id: 'extra-ipv4', name: 'Extra IPv4 Address', description: 'Additional dedicated IPv4 address for your VDS', price: 299, icon: 'tabler-network' },
  ...
  { id: 'windows-license', name: 'Windows License', description: 'Windows Server license for your VDS', price: 1499, icon: 'tabler-brand-windows' },
...
const VDSAddonsPage = () => {
  ...
  return (
    <Grid container spacing={6}>
      <Grid size={{ xs: 12 }}>
        <Box sx={{ mb: 2 }}>
          <Typography variant='h4'>VDS Add-Ons</Typography>
          <Typography variant='body2' color='text.secondary'>
            Enhance your VDS with additional services and dedicated resources
          </Typography>
        </Box>
      </Grid>
