...
const VDSPasswordResetPage = () => {
  ...
  return (
    <Grid container spacing={6}>
      <Grid size={{ xs: 12 }}>
        <Box sx={{ mb: 2 }}>
          <Typography variant='h4'>VDS Password Reset</Typography>
          <Typography variant='body2' color='text.secondary'>
            Reset the root password for your VDS with dedicated resources
          </Typography>
        </Box>
      </Grid>
              ...
              <CardContent>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                  ...
                  <Alert severity='warning'>
                    VDS will be restarted to apply new password. Plan this during low-traffic periods.
                  </Alert>
...
export default VDSPasswordResetPage
