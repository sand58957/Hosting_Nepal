...
const VDSRegionTransferPage = () => {
  ...
  return (
    <Grid container spacing={6}>
      <Grid size={{ xs: 12 }}>
        <Box sx={{ mb: 2 }}>
          <Typography variant='h4'>VDS Region Transfer</Typography>
          <Typography variant='body2' color='text.secondary'>
            Move your VDS with dedicated resources to a different data center region
          </Typography>
        </Box>
      </Grid>
...
export default VDSRegionTransferPage
