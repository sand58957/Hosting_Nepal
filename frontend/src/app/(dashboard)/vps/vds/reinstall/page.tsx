...
const VDSReinstallPage = () => {
  ...
  return (
    <Grid container spacing={6}>
      <Grid size={{ xs: 12 }}>
        <Box sx={{ mb: 2 }}>
          <Typography variant='h4'>Reinstall VDS OS</Typography>
          <Typography variant='body2' color='text.secondary'>
            Reinstall the operating system on your VDS with dedicated resources
          </Typography>
        </Box>
      </Grid>
        ...
        <>
          ...
          <Grid size={{ xs: 12 }}>
            <Alert severity='error' variant='filled' sx={{ mb: 2 }}>
              WARNING: This will ERASE all data on the VDS server! Make sure you have backups.
            </Alert>
          </Grid>
...
export default VDSReinstallPage
