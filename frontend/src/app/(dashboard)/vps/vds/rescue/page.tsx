...
const VDSRescuePage = () => {
  ...
  return (
    <Grid container spacing={6}>
      <Grid size={{ xs: 12 }}>
        <Box sx={{ mb: 2 }}>
          <Typography variant='h4'>VDS Rescue System</Typography>
          <Typography variant='body2' color='text.secondary'>
            Boot your VDS into rescue mode for server recovery
          </Typography>
        </Box>
      </Grid>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                  <Box sx={{ display: 'flex', gap: 2 }}>
                    ...
                    <Typography variant='body2'>
                      Click "Enable Rescue Mode" to boot the VDS into a minimal rescue system.
                    </Typography>
                  </Box>
                  <Box sx={{ display: 'flex', gap: 2 }}>
                    <Box sx={{ width: 28, height: 28, borderRadius: '50%', bgcolor: 'primary.main', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                  ...
                  <Box sx={{ display: 'flex', gap: 2 }}>
                    ...
                    <Typography variant='body2'>
                      Disable rescue mode and reboot the VDS to return to normal operation.
                    </Typography>
                  </Box>
                </Box>
              </CardContent>
