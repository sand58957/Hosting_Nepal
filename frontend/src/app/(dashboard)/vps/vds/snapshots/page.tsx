    ...
    <Grid container spacing={6}>
      <Grid size={{ xs: 12 }}>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
          <Box>
            <Typography variant='h4'>VDS Snapshots</Typography>
            <Typography variant='body2' color='text.secondary'>
              Manage snapshots for your VDS with dedicated resources
            </Typography>
          </Box>
          {selectedServer && (
            <Button
      ...
      {selectedServer && (
        <>
          ...
          <Grid size={{ xs: 12 }}>
            <Alert severity='info'>
              Snapshots capture the full VDS server state including all files, configurations, and installed software.
            </Alert>
          </Grid>
                ...
                {snapshotsLoading ? (
                  ...
                  <Box sx={{ textAlign: 'center', py: 6 }}>
                    ...
                    <Typography variant='body1' color='text.secondary' sx={{ mt: 2 }}>
                      No snapshots yet. Create one to save the current VDS server state.
                    </Typography>
                  </Box>
                ) : (
                  <TableContainer>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth='sm' fullWidth>
        <DialogTitle>Create VDS Snapshot</DialogTitle>
        <DialogContent>
          <Box sx={{ pt: 2, display: 'flex', flexDirection: 'column', gap: 3 }}>
            ...
            />
            <Alert severity='info'>
              The VDS server may briefly pause during snapshot creation.
            </Alert>
          </Box>
        </DialogContent>
        <DialogActions>
...
export default VDSSnapshotsPage
