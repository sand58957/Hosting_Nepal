    ...
    <Box sx={{ minHeight: '100vh', bgcolor: '#0f0f1a' }}>
      ...
      <Box sx={{ py: { xs: 6, md: 8 }, textAlign: 'center' }}>
        <Container maxWidth='md'>
          <Typography component='h1' variant='h3' fontWeight={800} sx={{ color: '#fff', mb: 1, fontSize: { xs: '1.8rem', md: '2.5rem' } }}>Privacy Policy</Typography>
